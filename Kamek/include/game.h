...
public:
	...
	//////////////////////////////////////////////////////////
	////////////// (Added by Walid for NewerLC) //////////////
	//////////////////////////////////////////////////////////
	
	float coinOffset; //used for Coin Fountain's position lags
};
...
public:
	...
	void SetupModel();
	void GetIfCurrentTypeIsMushroom();
	void GetWhetherPlayerCanGetPowerupOrNot();
	void SetDCAWhenPowerupSpawnTypeIsNotBorC();
...
class daBeltNeedle_c : public dEn_c {

public:

	bool isBuilt;
	REF_NINTENDO_STATE(MoveAttach); //Only the mentioned states have to figure in here
...
class dWaterManager_c {
	public:
		...
		u8 checkWater(float, float, u8, float*);
...
*/
//More choice for level types. Yay!
