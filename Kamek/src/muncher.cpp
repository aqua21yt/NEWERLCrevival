...
int dMuncher_c::onCreate() {
	...
	this->iceScale = (Vec){0.8f * this->scale.x, 0.8f * this->scale.y, 0.8f * this->scale.z};
	...
	physics.setup(this, 0.0f, 0.0f, 16.0f, 16.0f, (void*)&MuncherPhysCB1, (void*)&MuncherPhysCB2, (void*)&MuncherPhysCB3, 1, 0, 0);

	physics.flagsMaybe = 0x260;
	physics.callback1 = (void *)&MuncherPhysCB4;
	physics.callback2 = (void *)&MuncherPhysCB5;
	physics.callback3 = (void *)&MuncherPhysCB6;
...
void dMuncher_c::beginState_Frozen() {
	...
	this->iceScale = (Vec){0.8f * this->scale.x + this->xIceScaleOffset, 0.8f * this->scale.y, 0.8f * this->scale.z};
}
