...
int daBossKameckGiant_c::onCreate() {
	...
	ActivePhysics::Info VasYKamek;
	VasYKamek.xDistToCenter = 40.0;
	VasYKamek.yDistToCenter = 140.0;

	VasYKamek.xDistToEdge = 52.5;
	VasYKamek.yDistToEdge = 150.5;

	VasYKamek.category1 = 0x3;
	VasYKamek.category2 = 0x0;
	VasYKamek.bitfield1 = 0x4F;
	VasYKamek.bitfield2 = 0x8028E;
	VasYKamek.unkShort1C = 0;
	VasYKamek.callback = &dEn_c::collisionCallback;


	this->aPhysics.initWithStruct(this, &VasYKamek);
